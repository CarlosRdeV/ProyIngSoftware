...
namespace Cursos
{
    public partial class CrearAlumno : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd.CommandText = "insert into alumnos(nombre,direccion,edad,correoElectronico,tipoAlumno) values ('" + textBox1.Text + "','" + textBox2.Text + "'," + textBox3.Text + ",'" + textBox4.Text + "','" + textBox5.Text + "')";
